...
class Rectangle:
    ...
    def __str__(self):
        """return printable represatation of rectangle."""
        if self.__width == 0 or self.__height == 0:
            return ""

        rect = []
        for i in range(self.__height):
            [rect.append(str(self.print_symbol)) for j in range(self.__height)]
    ...
    def __del__(self):
        """Print a massege or every dalation of rectangle."""
        type(self).number_of_instances -= 1
        print("Bye rectangle...")
